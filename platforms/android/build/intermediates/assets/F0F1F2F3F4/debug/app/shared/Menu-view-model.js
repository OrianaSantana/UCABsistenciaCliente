  ...
  //}else{
    ...
    if (pageName == "preferencias" /*&& ls_validator.get('validar')== 0*/){
     ...
     // ls_validator('validar', 1);
      ...
      console.log("profesor id" + " " + ls_profesor.get('id'));
      console.log("profesor nombre" + " " + ls_profesor.get('profesor'));
     // ls_profesor('profesor',"");
    //  ls_profesor('id',"");
     // ls_correo('correo',"");
      //ls_preferencias('preferencias',"");
      //ls_notificaciones('notificaciones',"");
      //ls_horario('horario_profesor',"");
